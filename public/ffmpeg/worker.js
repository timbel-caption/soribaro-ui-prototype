/**
 * Self-contained FFmpeg.wasm Worker
 * @ffmpeg/ffmpeg v0.12.15의 worker.js를 import 없이 인라인화한 버전
 * COEP(Cross-Origin-Embedder-Policy) 환경에서 Blob URL로 로드하기 위함
 */

// ========== Inlined from @ffmpeg/ffmpeg/dist/esm/const.js ==========
...
// ========== Inlined from @ffmpeg/ffmpeg/dist/esm/errors.js ==========
...
// ========== Inlined from @ffmpeg/ffmpeg/dist/esm/worker.js ==========
let ffmpeg;
