...
// 녹취록 프로젝트 관리: 최종산출물 알림 발송 완료 시 '초안완성', 공증파일 알림 발송 완료 시 '완료'로 상태를 갱신
export const updateSampleOverallStatus = (id, overallStatus) => _updateSampleField(id, { overallStatus });

// 녹취록 진행의뢰 현황: '최종산출물 알림 발송' 클릭 시점의 날짜를 초안 업로드일로 기록
export const updateSampleDraftUploadDate = (id, draftUploadDate) => _updateSampleField(id, { draftUploadDate });
