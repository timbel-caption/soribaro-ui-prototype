              ...
              <div style={{ padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: '14px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px' }}>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                    ...
                    <input className="preg-input preg-input--no-spin" type="number" value={quoteForm.unitPrice} onChange={e => setQuoteForm(p => ({ ...p, unitPrice: +e.target.value }))} />
                  </div>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                    <label className="preg-label">기본 단위 (분)</label>
                    <input className="preg-input preg-input--no-spin" type="number" value={quoteForm.baseUnit} onChange={e => setQuoteForm(p => ({ ...p, baseUnit: +e.target.value }))} />
                  </div>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                    <label className="preg-label">올림 단위 (분)</label>
                    <input className="preg-input preg-input--no-spin" type="number" value={quoteForm.roundUnit} onChange={e => setQuoteForm(p => ({ ...p, roundUnit: +e.target.value }))} />
                  </div>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                    <label className="preg-label">n시간 이후 단가 (원/시간)</label>
                    <input className="preg-input preg-input--no-spin" type="number" value={quoteForm.overtimePrice} onChange={e => setQuoteForm(p => ({ ...p, overtimePrice: +e.target.value }))} />
                  </div>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
